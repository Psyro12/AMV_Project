...
<head>
  ...
  <style>
    ...
    .logo-container img { height: 50px; transition: 0.3s; }
    .logo-text { display: flex; flex-direction: row; font-weight: 700; line-height: 1.1; color: #fff; transition: color 0.4s ease; }
    header.scrolled .logo-text span{ color: #333; }
    header.scrolled .logo-container img { height: 40px; }
    
    nav { display: flex; align-items: center; }
    nav a { text-decoration: none; color: #fff; font-weight: 500; font-size: 14px; margin-right: 25px; text-transform: uppercase; letter-spacing: 1px; transition: color 0.4s ease; }
    header.scrolled nav a { color: #333; }
    nav a:hover { color: #b8860b; }

    .nav-icons { display: flex; gap: 15px; }
    .icon-circle { width: 35px; height: 35px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; color: #fff; border: 1px solid rgba(255,255,255,0.3); transition: all 0.4s ease; }
    header.scrolled .icon-circle { color: #555; border: 1px solid #ddd; }
    .icon-circle:hover { background-color: #b8860b; border-color: #b8860b; color: #fff !important; }
    .burger-menu { color: #fff; font-size: 24px; cursor: pointer; display: none; transition: color 0.4s ease; }
    header.scrolled .burger-menu { color: #333; }
    @media (max-width: 992px) { .desktop-icons { display: none; } .burger-menu { display: block; } header { padding: 20px 20px; } header.scrolled { padding: 15px 20px; } }
    ...
    .hero-text-overlay { padding-left: 8%; color: white; z-index: 2; max-width: 900px; margin-top: 50px; }
    .hero-sub { font-size: .75rem; font-weight: 600; text-transform: uppercase; letter-spacing: 4px; display: block; margin-bottom: 20px; opacity: 0; animation: fadeUp 1s ease forwards 0.5s; }
    .hero-main-title { font-size: 3rem; font-weight: 700; text-transform: uppercase; line-height: 1.1; margin: 0; opacity: 0; animation: fadeUp 1s ease forwards 0.8s; }
...
<body>
  ...
  <header id="mainHeader">
    ...
    <nav>
      <a href="#" class="nav-link">Your Reservations</a>
  ...
  <section class="intro" style="margin-top:60px;">
    <div class="intro-content"><div class="intro-text"><h2>About AMV Hotel</h2><p>Luxury and comfort combined.</p><a href="#" class="btn">Learn More</a></div><div class="intro-image"><img src="../../IMG/intro.png" alt="Intro"></div></div>
  </section>
                  ...
                  <?php foreach ($rooms as $index => $room): ?>
                    ...
                    <a href="room_booking.php?room_name=<?php echo urlencode($room['image_name']); ?>" 
                      ...
                      <div class="premium-img-wrapper">
                          ...
                          <img src="<?php echo $imageUrl; ?>" alt="<?php echo htmlspecialchars($room['image_name']); ?>" class="room-image">
                      </div>
  ...
  <section class="event-place">
    ...
    <div class="event-card">
      ...
      <div class="event-overlay">
        ...
        <a href="#" class="btn" style="background-color: #b8860b; color: white; border: none;">Contact Us Now</a>
      </div>
    </div>
  </section>
